 ...
 */
?>
<!-- wp:group {"align":"wide","backgroundColor":"primary","className":"landing-page__cover stick-on-top  is-style-page-header","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide landing-page__cover stick-on-top is-style-page-header has-primary-background-color has-background">
  <!-- wp:group {"layout":{"type":"constrained","contentSize":"1000px","wideSize":"1200px"}} -->
  <div class="wp-block-group">
    ...
    <div class="wp-block-columns alignfull is-not-stacked-on-mobile has-primary-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
      ...
      <div class="wp-block-column has-primary-background-color has-background" style="flex-basis:50%">
        <!-- wp:cover {"useFeaturedImage":true,"dimRatio":0,"minHeight":50,"minHeightUnit":"rem","isDark":false,"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
        <div class="wp-block-cover is-light" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;min-height:50rem"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span>
