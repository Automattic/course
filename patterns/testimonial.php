...
<div class="wp-block-group alignfull has-foreground-color has-primary-background-color has-text-color has-background" style="padding-top:80px;padding-right:20px;padding-bottom:120px;padding-left:20px">
    ...
    <div class="wp-block-group" style="border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-color:var(--wp--preset--color--tertiary);border-left-width:1px;padding-bottom:0px;padding-left:20px">
        <!-- wp:heading {"level":3,"style":{"typography":{"textTransform":"uppercase","lineHeight":"1"},"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"textColor":"tertiary","fontSize":"medium","fontFamily":"league-gothic"} -->
        <h3 class="has-tertiary-color has-text-color has-league-gothic-font-family has-medium-font-size" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;line-height:1;text-transform:uppercase"><?php echo esc_html__('What students say', 'course'); ?></h3>
        <!-- /wp:heading -->
    </div>
    <!-- /wp:group -->

    <!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"35px","left":"35px"},"padding":{"top":"40px"}}},"textColor":"tertiary"} -->
    <div class="wp-block-columns has-tertiary-color has-text-color" style="padding-top:40px">
        ...
        <!-- wp:column {"verticalAlignment":"bottom","fontFamily":"league-gothic"} -->
        <div class="wp-block-column is-vertically-aligned-bottom has-league-gothic-font-family">
            <!-- wp:group {"layout":{"type":"constrained","contentSize":"548px","justifyContent":"left"}} -->
            <div class="wp-block-group">
                <!-- wp:heading {"style":{"spacing":{"margin":{"bottom":"40px"}},"typography":{"textTransform":"uppercase","lineHeight":"1"}},"textColor":"tertiary","fontSize":"x-large","fontFamily":"league-gothic"} -->
                <h2 class="has-tertiary-color has-text-color has-league-gothic-font-family has-x-large-font-size" style="margin-bottom:40px;line-height:1;text-transform:uppercase"><?php echo esc_html__('“I always wanted to write, and thanks to Cours, I got it right. My writing is clearer, and I can finally get my message across.”', 'course'); ?></h2>
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->
            ...
            <p class="has-system-font-family has-xx-small-font-size" style="padding-top:10px;line-height:1"><?php echo esc_html__('Founder at BeautifulWriting.com', 'course'); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
    </div>
